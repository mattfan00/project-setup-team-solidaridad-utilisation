...
const Details = (props) => {
    ...
    return (
        <Descriptions column={1} bordered>
            ...
            {display("disability") ? <Descriptions.Item label = "Primary Phone">
                {props.Details.disability}
            </Descriptions.Item> : ""}
            {display("hispanicLatino") ? <Descriptions.Item label = "Primary Phone">
                {props.Details.hispanicLatino}
            </Descriptions.Item> : ""}
